...
namespace EVA2TI_BarPinguino.Migrations
{
    ...
    [Migration("20250123103039_VentasEnPreparacionNewState")]
    partial class VentasEnPreparacionNewState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EVA2TI_BarPinguino.Models.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Clave = "u5q3HQQ4dPynePpEjAq47xW+NMiQi/RLxSsDcu2Qzbw=",
                            Correo = "javier.nieves@alumnos.ipleones.cl",
                            Nombre = "Juan Perez",
                            PasswordSalt = "9anlhbr1YSBPECun/Xs6zQ==",
                            TipoUsuario = "Admin"
                        },
                        new
                        {
