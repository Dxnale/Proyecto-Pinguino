...
namespace EVA2TI_BarPinguino.Data
{
    public class AppDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var hashResult = _hasherService.HashPassword("1234");
            modelBuilder.Entity<Usuarios>().HasData(
                new Usuarios { CredencialVendedor = 111, Clave = hashResult.Hash, PasswordSalt = hashResult.Salt, Nombre = "Juan Perez", Correo = "javier.nieves@alumnos.ipleones.cl", TipoUsuario = "Admin" },
                new Usuarios { CredencialVendedor = 222, Clave = hashResult.Hash, PasswordSalt = hashResult.Salt, Nombre = "Maria Lopez", Correo = "benjamin.sequeida@alumnos.ipleones.cl", TipoUsuario = "Ventas" }
            );
